            ...
            <form role="form" method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <br>
                        <textarea name="content" id="" rows="15">{{old('content',$model->content)}}</textarea>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputFile">Ảnh</label>
                        <input type="file" id="exampleInputFile" name="image">
                        <br>
                        <img src="{{asset(old('image', $model->image))}}" alt="" width="150">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <br>
                    <textarea name="short_desc" id="" rows="10">{{old('short_desc',$model->short_desc)}}</textarea>
                </div>
                <!-- /.box-body -->
                <div class="form-group">
